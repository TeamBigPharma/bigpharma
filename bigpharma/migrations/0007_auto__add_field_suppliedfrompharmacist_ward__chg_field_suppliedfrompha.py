...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SuppliedFromPharmacist.ward'
        db.add_column(u'bigpharma_suppliedfrompharmacist', 'ward',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


        # Changing field 'SuppliedFromPharmacist.authorising_practitioner'
        db.alter_column(u'bigpharma_suppliedfrompharmacist', 'authorising_practitioner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['bigpharma.Practitioner']))

        # Changing field 'SuppliedFromPharmacist.datetime'
        db.alter_column(u'bigpharma_suppliedfrompharmacist', 'datetime', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ReceivedByPharmacist.datetime'
        db.alter_column(u'bigpharma_receivedbypharmacist', 'datetime', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'AdhocAdjustment.datetime'
        db.alter_column(u'bigpharma_adhocadjustment', 'datetime', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Deleting field 'SuppliedFromPharmacist.ward'
        db.delete_column(u'bigpharma_suppliedfrompharmacist', 'ward')


        # User chose to not deal with backwards NULL issues for 'SuppliedFromPharmacist.authorising_practitioner'
        raise RuntimeError("Cannot reverse this migration. 'SuppliedFromPharmacist.authorising_practitioner' and its values cannot be restored.")

        # Changing field 'SuppliedFromPharmacist.datetime'
        db.alter_column(u'bigpharma_suppliedfrompharmacist', 'datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ReceivedByPharmacist.datetime'
        db.alter_column(u'bigpharma_receivedbypharmacist', 'datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'AdhocAdjustment.datetime'
        db.alter_column(u'bigpharma_adhocadjustment', 'datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
