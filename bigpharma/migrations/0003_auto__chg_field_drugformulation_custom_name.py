...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DrugFormulation.custom_name'
        db.alter_column(u'bigpharma_drugformulation', 'custom_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'DrugFormulation.custom_name'
        db.alter_column(u'bigpharma_drugformulation', 'custom_name', self.gf('django.db.models.fields.CharField')(max_length=200))
