...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SuppliedFromPharmacist.created'
        db.add_column(u'bigpharma_suppliedfrompharmacist', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 5, 17, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'ReceivedByPharmacist.created'
        db.add_column(u'bigpharma_receivedbypharmacist', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 5, 17, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'AdhocAdjustment.created'
        db.add_column(u'bigpharma_adhocadjustment', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 5, 17, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SuppliedFromPharmacist.created'
        db.delete_column(u'bigpharma_suppliedfrompharmacist', 'created')

        # Deleting field 'ReceivedByPharmacist.created'
        db.delete_column(u'bigpharma_receivedbypharmacist', 'created')

        # Deleting field 'AdhocAdjustment.created'
        db.delete_column(u'bigpharma_adhocadjustment', 'created')
