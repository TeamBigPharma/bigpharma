...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SuppliedFromPharmacist.receiving_practitioner'
        db.delete_column(u'bigpharma_suppliedfrompharmacist', 'receiving_practitioner_id')

        # Adding field 'SuppliedFromPharmacist.supplied_individual'
        db.add_column(u'bigpharma_suppliedfrompharmacist', 'supplied_individual',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'SuppliedFromPharmacist.collected_by_patient'
        db.add_column(u'bigpharma_suppliedfrompharmacist', 'collected_by_patient',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SuppliedFromPharmacist.receiving_practitioner'
        db.add_column(u'bigpharma_suppliedfrompharmacist', 'receiving_practitioner',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='received_supplies', null=True, to=orm['bigpharma.Practitioner'], blank=True),
                      keep_default=False)

        # Deleting field 'SuppliedFromPharmacist.supplied_individual'
        db.delete_column(u'bigpharma_suppliedfrompharmacist', 'supplied_individual')

        # Deleting field 'SuppliedFromPharmacist.collected_by_patient'
        db.delete_column(u'bigpharma_suppliedfrompharmacist', 'collected_by_patient')
