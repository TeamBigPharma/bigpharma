...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Drug'
        db.create_table(u'bigpharma_drug', (
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200, primary_key=True)),
        ))
        db.send_create_signal(u'bigpharma', ['Drug'])


        # Changing field 'DrugFormulation.drug'
        db.alter_column(u'bigpharma_drugformulation', 'drug_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bigpharma.Drug']))

    def backwards(self, orm):
        # Deleting model 'Drug'
        db.delete_table(u'bigpharma_drug')


        # Changing field 'DrugFormulation.drug'
        db.alter_column(u'bigpharma_drugformulation', 'drug_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Drug']))
