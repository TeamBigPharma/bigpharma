...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Demographics.address'
        db.add_column(u'bigpharma_demographics', 'address',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Demographics.address'
        db.delete_column(u'bigpharma_demographics', 'address')
