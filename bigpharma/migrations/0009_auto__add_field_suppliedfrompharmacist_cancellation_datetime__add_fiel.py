...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SuppliedFromPharmacist.cancellation_datetime'
        db.add_column(u'bigpharma_suppliedfrompharmacist', 'cancellation_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'SuppliedFromPharmacist.cancellation_reason'
        db.add_column(u'bigpharma_suppliedfrompharmacist', 'cancellation_reason',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'ReceivedByPharmacist.cancellation_datetime'
        db.add_column(u'bigpharma_receivedbypharmacist', 'cancellation_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'ReceivedByPharmacist.cancellation_reason'
        db.add_column(u'bigpharma_receivedbypharmacist', 'cancellation_reason',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'AdhocAdjustment.cancellation_datetime'
        db.add_column(u'bigpharma_adhocadjustment', 'cancellation_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'AdhocAdjustment.cancellation_reason'
        db.add_column(u'bigpharma_adhocadjustment', 'cancellation_reason',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SuppliedFromPharmacist.cancellation_datetime'
        db.delete_column(u'bigpharma_suppliedfrompharmacist', 'cancellation_datetime')

        # Deleting field 'SuppliedFromPharmacist.cancellation_reason'
        db.delete_column(u'bigpharma_suppliedfrompharmacist', 'cancellation_reason')

        # Deleting field 'ReceivedByPharmacist.cancellation_datetime'
        db.delete_column(u'bigpharma_receivedbypharmacist', 'cancellation_datetime')

        # Deleting field 'ReceivedByPharmacist.cancellation_reason'
        db.delete_column(u'bigpharma_receivedbypharmacist', 'cancellation_reason')

        # Deleting field 'AdhocAdjustment.cancellation_datetime'
        db.delete_column(u'bigpharma_adhocadjustment', 'cancellation_datetime')

        # Deleting field 'AdhocAdjustment.cancellation_reason'
        db.delete_column(u'bigpharma_adhocadjustment', 'cancellation_reason')
    ...
    models = {
        ...
        u'bigpharma.adhocadjustment': {
            ...
            'cancellation_datetime': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'cancellation_reason': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
        ...
        u'bigpharma.suppliedfrompharmacist': {
            ...
            'amount': ('django.db.models.fields.IntegerField', [], {}),
            'authorising_practitioner': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'authorised_supplies'", 'null': 'True', 'to': u"orm['bigpharma.Practitioner']"}),
            'cancellation_datetime': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'cancellation_reason': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'cancelled': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'collected_by_patient': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'formulation': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bigpharma.DrugFormulation']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'pharmacist': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'supplied_individual': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'ward': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        },
